            ...
            if (viewModels.Count == 0)
            {
                ...
                foreach (Attraction attraction in attractions)
                {
                    ...
                    foreach (int locationId in attraction.LocationIds)
                    {
                        ...
                        /*
                        viewModel.Locations[index].Id = location.Id;
                        viewModel.Locations[index].StreetAddress = location.StreetAddress;
                        viewModel.Locations[index].City = location.City;
                        viewModel.Locations[index].State = location.State;
                        viewModel.Locations[index].Zip = location.Zip;
                        viewModel.Locations[index].GPS = location.GPS;
                        */
                    }
                }
