...
namespace MVCStLouisSites.ViewModels.DisplayAttractions
{
    ...
    {
        public static List<AttractionSplashIndexViewModel> models = new List<AttractionSplashIndexViewModel>();

        public static List<AttractionSplashIndexViewModel> GetAttractionSplashIndexViewModel()
        {
            AttractionSplashIndexViewModel model = new AttractionSplashIndexViewModel();
        ...
        public static AttractionSplashIndexViewModel GetAttractionSplashViewModelById (int id)
        {
            if (models.Count == 0)
            {
                models = GetAttractionSplashIndexViewModel();
            }
